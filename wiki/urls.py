...
from .views import get_entry_comments_api, get_entry_comments_by_id_api, get_comment_fqid_api, register_api, login_api, get_author_likes_api, get_single_like_api, get_entry_image_api, get_author_image_api, get_author_comments_api,user_wiki_api
...
urlpatterns = [
    ...
    path('api/entries/<uuid:entry_serial>/comments/', get_entry_comments_by_id_api, name='get_entry_comments_by_id_api'),
