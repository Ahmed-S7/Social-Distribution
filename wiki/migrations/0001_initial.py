# Generated by Django 5.2.3 on 2025-06-15 03:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='following', to='wiki.author')),
                ('following', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='followers', to='wiki.author')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='follow_requests', to='wiki.author')),
                ('requester', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requesting', to='wiki.author')),
            ],
            options={
